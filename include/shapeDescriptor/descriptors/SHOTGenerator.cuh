...
namespace ShapeDescriptor {
    ...
    //             ShapeDescriptor::gpu::array<ShapeDescriptor::SHOTDescriptor<ELEVATION_DIVISIONS, RADIAL_DIVISIONS, AZIMUTH_DIVISIONS, INTERNAL_HISTOGRAM_BINS>>& descriptors,
    //             const ShapeDescriptor::gpu::array<ShapeDescriptor::LocalReferenceFrame>& localReferenceFrames,
    ...
    //             const float3 vertex_test = descriptorOrigins.content[descriptorIndex].vertex;
    //             const float3 normal = descriptorOrigins.content[descriptorIndex].normal;
    ...
    //                 const float3 samplePoint = pointCloud.vertices[sampleIndex];
    ...
    //                 const float3 sampleNormal = normalize(pointCloud.normals[sampleIndex]);
    ...
    //     }
        ...
        void computeGeneralisedSHOTDescriptor(
                ...
                ShapeDescriptor::gpu::array<ShapeDescriptor::SHOTDescriptor<ELEVATION_DIVISIONS, RADIAL_DIVISIONS, AZIMUTH_DIVISIONS, INTERNAL_HISTOGRAM_BINS>> descriptors,
                ShapeDescriptor::gpu::array<ShapeDescriptor::gpu::LocalReferenceFrame> localReferenceFrames,
                ShapeDescriptor::gpu::array<float> supportRadii) {
            printf("Hello there!\n");
        }
    }
    ...
    gpu::array<ShapeDescriptor::SHOTDescriptor<ELEVATION_DIVISIONS, RADIAL_DIVISIONS, AZIMUTH_DIVISIONS, INTERNAL_HISTOGRAM_BINS>> generateSHOTDescriptorsMultiRadius(
        ...
        internal::computeGeneralisedSHOTDescriptor<ELEVATION_DIVISIONS, RADIAL_DIVISIONS, AZIMUTH_DIVISIONS, INTERNAL_HISTOGRAM_BINS>(descriptorOrigins, pointCloud, descriptors, referenceFrames, supportRadii);
