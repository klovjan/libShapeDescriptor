    ...
    SHOTExecutionTimes* executionTimes = nullptr)
{
    ...
    calculateCovarianceMatrices<<<originCount, 512>>>(pointcloud, imageOrigins, maxSupportRadius, d_covarianceMatrices);
    ...
    ShapeDescriptor::gpu::array<float> d_eigenvectors = ShapeDescriptor::v3::computeEigenVectorsMultiple(d_covarianceMatrices, originCount);
